...
// Brand icons removed from lucide-react in v1; same SVG paths, same props surface.
type BrandIconProps = React.SVGProps<SVGSVGElement> & { size?: number };

function createBrandIcon(label: string, paths: React.ReactNode) {
